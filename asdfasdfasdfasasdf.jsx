...
function Profile() {
  ...
  const editProfile = async (updatedData) => {
    try {
      ...
      const response = await axios.post(API_EDIT_PROFILE_URL, updatedData, {
        headers: {
          Authorization: `Bearer ${token}`,
          Accept: "application/json",
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          ...
          {/* Account Stats */}
          <View
            style={[styles.statsGrid, { borderTopColor: colors.border + "80" }]}
          >
            <View style={styles.statCard}>
              ...
              <Text style={[styles.statValue, { color: colors.text }]}>
                {loading && !refreshing
                  ? "..."
                  : `#${(profileData?.id || user?.id || "000000").toString().slice(-6)}`}
              </Text>
            ...
            {profileData.address && (
              <View style={styles.infoRow}>
                ...
                <Text
                  style={[
                    styles.infoText,
                    { color: colors.textLight, marginLeft: 8 },
                  ]}
                >
                  {profileData.address}
                </Text>
        ...
        >
          ...
          <View style={styles.logoutTextContainer}>
            <Text style={[styles.logoutTitle, { color: colors.danger }]}>
              Logout
            </Text>
            <Text style={[styles.logoutSubtitle, { color: colors.textLight }]}>
